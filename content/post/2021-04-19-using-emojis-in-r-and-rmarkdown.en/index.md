...
I was surprised that there is a special package. I did'’t think that including emojis would'’t be a problem---— at least on the macOS. I only have to open the window for emojis and symbols (CMD-SHIFT-SPACE) and double click on the icon to insert it into the markdown document. No big deal, so wha'’s the matter?
